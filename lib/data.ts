...
const products: IProductInput[] = [
  // T-Shirts
  {
    ...
    countInStock: 11,
    description:
      'The Nike Slim-Fit Long-Sleeve T-Shirt is made from soft, breathable fabric that wicks away sweat to keep you comfortable during your workouts. Its slim fit design provides a modern look while allowing for a full range of motion.',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
